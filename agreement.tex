...
\newcommand{\lbirth}{lod/dat/bir}
\newcommand{\lss}{lod-ss-numb}
\newcommand{\lodgeremail}{lodger@email.com}
...
\begin{multicols}{2}
	\begin{enumerate} 
		...
		\item \textbf{Lodger}: \label{lodger}
			\lname{}\\*
			Date Of Birth: \lbirth{}\\*
			Social Security Number: \lss{}
...
\textbf{I have read and been given copies of all sections and schedules of this Agreement:} \vspace{.1cm}

\tabmed{Section \ref{specifics}} \tablarge{\textbf{\specifics{}}} \tabsmall{Initial:\hspace{0.2cm}\initialfillin}

\tabmed{Section \ref{definitions}} \tablarge{\textbf{\definitions{}}} \tabsmall{Initial:\hspace{0.2cm}\initialfillin}

\tabmed{Schedule \ref{therental}} \tablarge{\textbf{\therental{}}} \tabsmall{Initial:\hspace{0.2cm}\initialfillin}

\tabmed{Schedule \ref{payments}} \tablarge{\textbf{\payments{}}} \tabsmall{Initial:\hspace{0.2cm}\initialfillin}

\tabmed{Schedule \ref{terminating}} \tablarge{\textbf{\terminating{}}} \tabsmall{Initial:\hspace{0.2cm}\initialfillin}

\tabmed{Schedule \ref{behavior}} \tablarge{\textbf{\behavior{}}} \tabsmall{Initial:\hspace{0.2cm}\initialfillin}

\tabmed{Schedule \ref{rules}} \tablarge{\textbf{\rules{}}} \tabsmall{Initial:\hspace{0.2cm}\initialfillin}

\tabmed{Schedule \ref{standards}} \tablarge{\textbf{\standards{}}} \tabsmall{Initial:\hspace{0.2cm}\initialfillin}

\tabmed{Schedule \ref{meta}} \tablarge{\textbf{\meta{}}} \tabsmall{Initial:\hspace{0.2cm}\initialfillin}

\label{acceptance}
By signing below, I acknowledge having received a copy of, and having read and understood, this \agreementdef{}. This agreement is entered into on \today{} and will be effective on the \firstday{}. 
...
\begin{enumerate}
	\item \textbf{Method Of Payment Of Monetary Obligations}. \label{paymethod}
		...
		\begin{enumerate} 
			...
			\item \textbf{Rejected Payment Fees}. If any form of payment offered by Lodger in payment of Rent or any other amount due under this Agreement is returned for lack of sufficient funds, a ``stop payment,'' or any other reason, Lodger will pay the Owner the returned payment fees, if any, charged by Wells Fargo Bank upon rejecting the payment.
	...
	\item \textbf{Automatic Renewal}. Unless terminated, this Agreement shall be automatically renewed weekly on the same terms and conditions. 
			\item \textbf{Rent And Rent Due Date}. The Lodger shall pay the Owner a weekly rent of \rent{}. Rent shall be paid on or before each Monday, which is the last day of each \rentweek{}.
			\item \textbf{Delinquent Rent}. \label{due}
				Rent is delinquent if the \paymenttime{} is later than 11:59pm Pacific Standard Time on Monday, the last day of the \rentweek{} when due. 
			\item \textbf{Pay Or Quit}. Should Lodger allow the Rent to become delinquent in accordance with item \ref{due} of this section of the Agreement, a notice to pay the Rent or quit will be served. 
		\end{enumerate} 
...
\begin{enumerate}
	\item \textbf{Criminal And Drug Related Activities}. 
		In an effort to keep Owner safe in her own home, \management{} is taking a ``zero tolerance'' position towards any of the Criminal or Drug-Related Criminal activities described on this page. 
		\begin{enumerate} 
...
\begin{enumerate}
	...
	\item Without prior written approval of \management{}, nothing provided in the \room{} may be moved or removed from the \room{}, and personal property shall not be stored outside the \room{} at any time.
	\item Without prior written approval of \management{}, nothing provided in \shared{} may be removed from the area it is in other than items in closets or cupboards, and nothing provided in the \apt{} may be removed from the \apt{}. 
	\item All \shared{} shall remain free from obstruction at all times. 
	...
	\item Alcoholic beverages shall not be consumed in the public areas of \condo{}. 
...
\begin{enumerate}
	...
	\item not store dishes, pots, pans, or other cooking utensils in the sink (instead, they may be put in the container provided by \management{} for that purpose until actually washing them and the container as well);
	\item keep all closets and other storage areas neat and clean; 
	\item keep the laundry area neat;
	...
	\item keep the bathroom exhaust fan free of dust; 
...
\begin{enumerate}
	\item \textbf{Modifications And Amendments To This Agreement}. \label{modifications}
		...
		\begin{enumerate}
			...
			\item \management{} (without the written consent of the Lodger) at any time during the term of the Agreement upon 30 or 60 day written notice as required by law. 
		\end{enumerate}
