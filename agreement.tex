...
\begin{enumerate}
	...
	\item \textbf{Automatic Renewal}. Unless terminated, this Agreement shall be automatically renewed weekly on the same terms and conditions. 
			\item \textbf{Rent And Rent Due Date}. The Lodger shall pay the Owner a weekly rent of \rent{}. Rent shall be paid on or before the seventh (7th) day of each \rentweek{}.
		...
		\begin{enumerate}
			...
			\item \textbf{Involuntary Termination Notices}. \label{terminate}
				...
				\begin{enumerate}
					...
					\item a reasonable time considering the seriousness of the situation (but not exceeding 7 days) when the health or safety of Owner, \management{}, or any other \condo{} resident is threatened;
