...
\newcommand{\agreementdef}{agreement, titled \agreementtitle{}, including sections \ref{specifics} and \ref{definitions} on pages 1 through \pageref{acceptance} as well as Schedules \ref{therental} through \ref{disclosures} on pages \pageref{therental} through \pageref{LastPage}}

\renewcommand{\theenumi}{\textit{\arabic{enumi}}} %these 12 lines make item references have the same punctuation as the item being referenced
\renewcommand{\labelenumi}{\theenumi}
\renewcommand{\theenumii}{\textit{(\alph{enumii})}}
\renewcommand{\labelenumii}{\theenumii}
\renewcommand{\theenumiii}{\textit{\roman{enumiii}}}
\renewcommand{\labelenumiii}{\theenumiii}
\renewcommand{\theenumiv}{\textit{(\Alph{enumiv})}}
...
\newcommand{\myaddress}{Management Address and Phone}
...
\newcommand{\occdate}{the/occ/date}
...
\begin{multicols}{2}
	\begin{enumerate} 
		...
		\item \textbf{\myaddress{}}\\* \label{myaddress}
			Colin Keenan
			3835 Park Ave
...
\columnbreak
		...
		\item \textbf{Drug-Related Criminal Activity}\\*
			the illegal manufacture, sale, distribution, use or possession with the intent to manufacture, sell, distribute or use a controlled substance as defined in section 802 of the Controlled Substances Act (21 U.S.C. 802) 
...
\tabmed{Section \ref{specifics}} \tablarge{\textbf{\specifics{}}} \tabsmall{Initial:\hspace{0.2cm}\initialfillin} \vspace{.3cm}

\tabmed{Section \ref{definitions}} \tablarge{\textbf{\definitions{}}} \tabsmall{Initial:\hspace{0.2cm}\initialfillin} \vspace{.3cm}

\tabmed{Schedule \ref{therental}} \tablarge{\textbf{\therental{}}} \tabsmall{Initial:\hspace{0.2cm}\initialfillin} \vspace{.3cm}

\tabmed{Schedule \ref{payments}} \tablarge{\textbf{\payments{}}} \tabsmall{Initial:\hspace{0.2cm}\initialfillin} \vspace{.3cm}

\tabmed{Schedule \ref{terminating}} \tablarge{\textbf{\terminating{}}} \tabsmall{Initial:\hspace{0.2cm}\initialfillin} \vspace{.3cm}

\tabmed{Schedule \ref{behavior}} \tablarge{\textbf{\behavior{}}} \tabsmall{Initial:\hspace{0.2cm}\initialfillin} \vspace{.3cm}

\tabmed{Schedule \ref{rules}} \tablarge{\textbf{\rules{}}} \tabsmall{Initial:\hspace{0.2cm}\initialfillin} \vspace{.3cm}

\tabmed{Schedule \ref{standards}} \tablarge{\textbf{\standards{}}} \tabsmall{Initial:\hspace{0.2cm}\initialfillin}\vspace{.3cm} 

\tabmed{Schedule \ref{meta}} \tablarge{\textbf{\meta{}}} \tabsmall{Initial:\hspace{0.2cm}\initialfillin} \vspace{.3cm}

\tabmed{Schedule \ref{disclosures}} \tablarge{\textbf{\disclosures{}}} \tabsmall{Initial:\hspace{0.2cm}\initialfillin} \vspace{.3cm}

\newpage \label{acceptance}
{\small\noindent\textbf{CAUTION: THIS IS A LEGALLY BINDING AGREEMENT; MAKE SURE YOU UNDERSTAND ALL OF ITS PROVISIONS BEFORE SIGNING} \\*
By signing below, I acknowledge having received a copy of, and having read and understood, this \agreementdef{}. This agreement is entered into on \today{} and will be effective on \occdate{}.
...
\begin{enumerate}
	\item \textbf{Method Of Payment Of Monetary Obligations}. \label{paymethod}
		All payments of Rent and any other monetary sums due under the terms of this Agreement shall be made either via Venmo or via Wells Fargo Bank. 
		\begin{enumerate} 
			\item \textbf{Venmo}. Payments made via Venmo shall be made to the Venmo account associated with the Owner's email address (the ``\ownermail{}'') that is set forth in item \ref{ownermail} of section \ref{definitions} of this Agreement{}. Venmo's website is https://venmo.com/; Venmo also has apps for Android and iOS. 
			\item \textbf{Wells Fargo Bank, 82 S Lake Ave, Pasadena, CA 91101}. Payments made via Wells Fargo Bank shall be deposited at Wells Fargo Bank at 82 S Lake Ave, Pasadena, CA 91101 into the checking account for THE JOAN B. HARRISON FAMILY TRUST with account number 8139769759. Payments may be made in any form accepted by that Wells Fargo Bank branch.
			\item \textbf{Rejected Payment Fee}. If any form of payment offered by Lodger in payment of Rent or any other amount due under this Agreement is returned for lack of sufficient funds, a ``stop payment,'' or any other reason, Lodger will pay the Owner a returned payment fee of \$25 for the first payment made by Lodger and rejected by the bank, and \$35 for every subsequent rejected payment.
			\item \textbf{\paymenttime{}}. \label{defpaytime} 
				\begin{enumerate}
					\item Venmo will notify \management{} of the payment via the \ownermail{}. 
					\item Lodger should notify \management{} of Wells Fargo Bank deposits via the \ownermail{} and \management{} shall log onto https://online.wellsfargo.com to confirm the deposit shows as pending or posted. If the deposit does not show up at https://online.wellsfargo.com, \management{} shall notify the Lodger of this situation via reply to the Lodger's emailed notification of payment, and contact the bank to find out if systems are up and if there is any way to confirm the deposit. \management{} shall check with the Bank again at close of business day and every business day following until the actual payment date has been determined.
					\item \management{} will consider the payment as having been received at the time and date stamped on either the Venmo notification, or the Lodger notification if https://online.wellsfargo.com also shows the deposit on the same business day, (``\paymenttime{}''). If payment is made via Wells Fargo Bank, but https://online.wellsfargo.com does not show the deposit on the same business day, the \paymenttime{} will match the date as reported by Wells Fargo Bank.
				\end{enumerate}
			\item \textbf{No Other Payment Method or Location}. Lodger shall not make any payment in person or through the mail to Owner or any other member of \management{}. Although Lodger may feel it would be more convenient to pay the Owner in person, the Lodger shall not do so. Payments are not useful unless in the Owner's checking account, and due to medical conditions, Owner will not make deposits into her checking account.
			\item \textbf{Receipt}. \management{} will provide receipt of payment via the \lemail{} that is set forth in item \ref{lemail} of section \ref{definitions} of this Agreement{} (``\lemail{}''), and record payment was received at the \paymenttime{}. 
		\end{enumerate}
	\item \textbf{Payments Of Rent Due Under This Agreement}. 
		\begin{enumerate}
			\item \textbf{Rental Term}. The Lodger may put personal property into, and begin making use of, the \room{} on \\* \\ 
				Tuesday, \datefillin, 2015 (the ``\firstday{}''). \\
				The first \rentweek{} shall begin on the \firstday{} and shall end on \\* \\
				Monday, \datefillin, 2015. Every seven days is another \rentweek{}. Every Tuesday will be the start of another \rentweek{} and every Monday will be the end of the \rentweek{}. (``\rentweek'')
	\item \textbf{Automatic Renewal}. Unless terminated, this Agreement shall be automatically renewed weekly on the same terms and conditions. 
			\item \textbf{Rent And Rent Due Date}. The Lodger shall pay the Owner a weekly rent of \rent{}. Rent shall be paid on or before each Monday, which is the last (that is, the 7th) day of each \rentweek{}.
			...
			\item \textbf{Late Charge}. Because Owner and Lodger agree that actual damages for late rent payments are very difficult or impossible to determine, Owner and Lodger agree to the following stated late charge as liquidated damages. Should Lodger allow the Rent to become delinquent in accordance with item \ref{due} of this section of Agreement, Lodger shall be charged a \$5 late fee, plus \$1 for each additional day that the rent continues to be unpaid.  The total late charge for any one week will not exceed \$10. Any notice to the Lodger that a late charge has been assessed shall not waive, or otherwise affect, any rental agreement termination notice or lawsuit. Tender of late fees after the expiration of a rental agreement termination notice shall not waive said notice or the right to effect the removal of Lodger from \apt{} based on the notice. 
		\end{enumerate} 
	\item \textbf{Utility Services}. 
		\begin{enumerate} 
			\item \textbf{Utilities Provided}. \management{} shall not provide any utilities or other services to the \room{} or the \apt{} except water, sewer, rubbish removal, electricity, natural gas, and broadband internet, as set forth in item \ref{utilities} of section \ref{definitions}, (the ``\utilities{}'')
	...
	\item \textbf{Other Charges}.
		\begin{enumerate} 
			\item \textbf{Other Charges}. \label{othercharges}
				Lodger shall pay for the cost of repairing any damages made to the \room{}, the \apt{}, and the common areas of \condo{} caused by the Lodger, guests, or other visitors of the Lodger. These other charges (``Other Charges'') shall be billed to Lodger and will specify the damaged items, corrective action taken, and cost of labor and/or materials to correct the damages. 
	...
	\item \textbf{Defaults And Terminations}. 
		\begin{enumerate}
			\item \textbf{Terminations}. 
				This Agreement shall be terminated upon the death of Lodger, upon a voluntary termination of this Agreement by Lodger, or upon termination by \management{}. 
			\item \textbf{Termination Notices By Lodger}. 
			...
			\item \textbf{Termination Notices By \management{}}. \label{terminate}
				...
				\begin{enumerate}
					...
					\item 3 days for a violation of any provision of the Agreement; and
					\item 30 days in any other case during the first year of this Agreement or otherwise allowed by law, or 
					\item 60 days in any other case.
				\end{enumerate} 
				The Notice of Termination shall state that Lodger is not welcome in \apt{} anymore, provide a reminder that only Owner and Lodger reside in this \apt{}, and contain a statement about reclaiming personal property pursuant to California Civil Code 1946.1(h). If the notice period is less than 30 days, the Notice of Termination shall also provide the justifying reason for shorter notice. 
	...
	\item \textbf{Criminal And Drug Related Activities}. 
		...
		\begin{enumerate} 
			\item \textbf{Criminal Activity}. \label{criminal}
				\begin{enumerate}
					...
					\item The Lodger specifically understands and acknowledges that: 
						\begin{enumerate} 
							\item	The Lodger has an obligation to ensure that the Lodger, guest, or other person under his or her control commits no such criminal or illegal activity; 
			...
			\item \textbf{Criminal Drug Related Activity}. \label{drug}
				...
				\begin{enumerate}
					\item The Lodger has an obligation to ensure that the Lodger, or guest, or other person under his or her control do not commit any Drug-Related Criminal Activity; 
...
\begin{enumerate}
	...
	\item Without prior written approval of \management{}, nothing provided in the \apt{} may be removed from the \apt{}.
	...
	\item Lodger is required to maintain the grounds immediately surrounding the \room{} in good condition. 
...
\begin{enumerate}
	...
	\item keep all trash in an appropriately covered container and remove all trash from the \room{} and the \apt{} on at least a weekly basis;
