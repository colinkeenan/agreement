...
\newcommand{\definitions}{Definitions} %I
\newcommand{\generals}{General Terms of Agreement}	%II
\newcommand{\notice}{Notice To Lodger\\* Data Base Of Registered Sex Offender} %III
\newcommand{\specifics}{Specifics of Agreement}			%IV
\newcommand{\rules}{Residential Rules}							%V
\newcommand{\standards}{Residential Housekeeping Standards}	%VI
			...
			\item \textbf{Delinquent Rent} \quad \label{due}
				\begin{enumerate}
					...
					\item \textbf{Possible Delay of Delinquency If Employed By Management} \quad If \lodger{} is employed by \management{}, the rent will not be considered delinquent if paid on the upcoming payday for the work week that includes the first day of the \rentweek{} for which rent is due. That is, the Rent will be delinquent if the \paymenttime{} is later than the latest of the following two times 
						\begin{enumerate}
							\item 11:59pm on the seventh (7th) day of the week when due 
							\item 10 hours after the time-date stamp according to email received from Venmo at \management{}'s email address (the `\myemail{}') that is set forth in item \ref{myemail} of section \ref{specifics} of this Agreement{}, of \management{}'s Venmo Payment for work done in the week that includes the first day of the \rentweek{} for which rent is due. 
						\end{enumerate} 
						\begin{example} 
							Colin became employed by \management{} on the \firstday{}, which was a Monday. Colin's first 7th day is the following Sunday, which is also the end of his first work week. \management{} paid Colin via Venmo for his first week of work on Monday - a day late for the Rent payment according to the standard due date. \management{} received an email from Venmo confirming payment was made to Colin at 11:59am Pacific Standard Time on Monday, 12 hours after 11:59pm of the 7th day of the week when Rent became due. Colin's Rent will not be delinquent as long as he pays via Venmo by 10pm Pacific Standard Time on that Monday (the day \management{} paid for his first week of work).
						\end{example}
						\begin{example} 
							Colin became employed by \management{} on Saturday, 2 days before the \firstday{}, which was a Monday. Colin's first 7th day is the following Sunday, but his work week ended 2 days earlier, on Friday. \management{} paid Colin via Venmo for his first week of work on Saturday - a day early for the Rent payment according to the standard due date. Colin's Rent will be delinquent if he doesn't pay via Venmo by 11:59pm on Sunday, his 7th day.
						\end{example}
				\end{enumerate}
			\item \textbf{Pay Or Quit} \quad Should \lodger{} allow the Rent to become delinquent in accordance with item \ref{due} of this section of Agreement, a notice to pay the Rent or quit will be served. 
			\item \textbf{Late Charge} \quad Should \lodger{} allow the Rent to become delinquent in accordance with item \ref{due} of this section of Agreement, \lodger{} shall be charged a \$5 late fee. Payment of the late fee shall be due on the seventh (7th) day of the following week. Any notice to the \lodger{} that a late charge has been assessed shall not waive, or otherwise affect, any rental agreement termination notice or lawsuit. Tender of late fees after the expiration of a rental agreement termination notice shall not waive said notice or the right to remove Lodger's possessions, and remove Lodger from Apartment as a trespasser, based on the notice. 
		\end{enumerate} 
	...
	\item \textbf{Criminal And Drug Related Activities} \quad 
		...
		\begin{enumerate} 
			\item \textbf{Criminal Activity} \quad \label{criminal}
				...
				\end{enumerate}
			\item \textbf{Criminal Drug Related Activity} \quad \label{drug}
				...
				\end{enumerate}
		\end{enumerate}
	\item \textbf{Lodger's Obligations} \quad
...
\begin{multicols}{2}
	\begin{enumerate} 
		...
		\item \textbf{\shared{}}\\* \label{shared}
			...
			the kitchen\\*
			top-floor bathroom\\*
			\textit{In locked carport behind \apt{}}\\*
...
\begin{enumerate}
	...
	\item No large moving vans or vehicles capable of damaging the balconies may enter the gated parking area. Incidences have occurred in the past causing expensive damage that the new owner/tenant was financially responsible for repairing. Please park outside the main gate while you are moving your belongings and leave enough space for the rest of the residence to maneuver in and out of the driveway. 
	...
	\item Within the \condo{} carport area, \lodger{} shall only park in their assigned space. Any vehicles parked in violation will be towed away at \lodger{}'s expense.
	...
	\item Trash cans, bottles, brooms, mps, etc., should be kept out of sight.
	...
	\item No pets or animals other than a small one (dog or cat) approved in writing by \management{} shall be kept. For that pet, \lodger{} shall keep that pet wearing a current license tag issued by The Pasadena Humane Society at all times, keep track of the current rabies certificate for that pet, and thoroughly clean up after that pet, using appropriate measures to reduce pet odors and stains. \lodger{} shall walk their dog frequently enough to reduce indoor issues. However, Owner is against corporal punishment or overly harsh words towards pets, and \lodger{} shall refrain from correcting pet behavior in those ways.
