...
\newcommand{\schedule}[1]{%
	...
	\noindent \textbf{\Large Schedule \Alph{schedulecounter}:~{#1}}\\ \\}
...
\noindent \hrulefill
\section{\specifics{}}
	Important points from Schedule \Alph \ref{generals}, \generals{}, are repeated or restated as follows so as to not be missed by \lodger{}.
	\begin{enumerate}
		...
		\item \textbf{Impermanence, \rules{}, and \standards{}}\\*
			...
			\begin{enumerate}
				...
				\item \management{} desires that \lodger{} clearly understands how to avoid premature termination of this Agreement, and so has provided rules as listed in Schedule \Alph \ref{rules} of this Agreement (``\rules{}''), and housekeeping standards as listed in Schedule \Alph \ref{standards} of this Agreement (``\standards{}''). 
...
\section{Definitions} \label{definitions}
	In this section of this section of the Agreement, the meaning of the capitalized words referred to throughout this Agreement are established
	\begin{multicols}{2}
		\begin{enumerate} 
			...
			\item \textbf{\paymenttime{}}\\* \label{paymenttime}
				Defined in item \ref{defpaytime} of Schedule \Alph \ref{generals} of this Agreement.
	...
	\tabmed{Section \ref{specifics}} \tablarge{\textbf{\specifics{}}} \tabsmall{Initial:\hspace{0.2cm}\makebox[1.5cm]{\hrulefill}} \\
	
	\tabmed{Schedule \Alph \ref{generals}} \tablarge{\textbf{\generals{}}} \tabsmall{Initial:\hspace{0.2cm}\makebox[1.5cm]{\hrulefill}} \\

	\tabmed{Schedule \Alph \ref{rules}} \tablarge{\textbf{\rules{}}} \tabsmall{Initial:\hspace{0.2cm}\makebox[1.5cm]{\hrulefill}} \\

	\tabmed{Schedule \Alph \ref{standards}} \tablarge{\textbf{\standards{}}} \tabsmall{Initial:\hspace{0.2cm}\makebox[1.5cm]{\hrulefill}} \\
	...
	\schedule{\standards{}} \label{standards}
