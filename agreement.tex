...
\newcommand{\tab}[1]{%
	\settowidth{\tabcont}{#1}%
	\ifthenelse{\lengthtest{\tabcont < .05\linewidth}}%
		{\makebox[.05\linewidth][l]{#1}\ignorespaces}%
		{
			\ifthenelse{\lengthtest{\tabcont < .15\linewidth}}%
				{\makebox[.15\linewidth][l]{#1}\ignorespaces}%
				{\makebox[.75\linewidth][l]{#1}\ignorespaces}%
		}%
	}%
...
\noindent \textbf{I have read and been given copies of all four sections of this Rental Agreement:}\\*
\textbf{\tab{\ref{generals}} \tab{\generals{}}} \tab{Initial:\hspace{0.2cm}\makebox[1.5cm]{\hrulefill}}\\*
\textbf{\tab{\ref{specifics}} \tab{\specifics{}}} \tab{Initial:\hspace{0.2cm}\makebox[1.5cm]{\hrulefill}}\\*
\textbf{\tab{Schedule A} \tab{\rules{}}} \tab{Initial:\hspace{0.2cm}\makebox[1.5cm]{\hrulefill}}\\*
\textbf{\tab{Schedule B} \tab{\standards{}}} \tab{Initial:\hspace{0.2cm}\makebox[1.5cm]{\hrulefill}}\\*
