...
\tabmed{Schedule \ref{standards}} \tablarge{\textbf{\standards{}}} \tabsmall{Initial:\hspace{0.2cm}\makebox[1.5cm]{\hrulefill}} 
...
Signing below signifies acceptance of this entire Agreement (having previously received and read it), including sections \ref{specifics} and \ref{definitions} as well as Schedules \ref{therental} through \ref{disclosures}.
