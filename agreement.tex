...
\newcommand{\tab}[1]{%
	\settowidth{\tabcont}{#1}%
	\ifthenelse{\lengthtest{\tabcont < .16\linewidth}}%
		{\makebox[.16\linewidth][l]{#1}\ignorespaces}%
		{
			\ifthenelse{\lengthtest{\tabcont < .2\linewidth}}%
				{\makebox[.2\linewidth][l]{#1}\ignorespaces}%
				{\makebox[.6\linewidth][l]{#1}\ignorespaces}%
		}%
	}%
...
\subsection{Definitions} \label{definitions}
	...
	\tab{\ref{generals}} \tab{\textbf{\generals{}}} \tab{Initial:\hspace{0.2cm}\makebox[1.5cm]{\hrulefill}}\\ \\*
	\tab{\ref{specifics}} \tab{\textbf{\specifics{}}} \tab{Initial:\hspace{0.2cm}\makebox[1.5cm]{\hrulefill}}\\ \\*
	\tab{Schedule A} \tab{\textbf{\rules{}}} \tab{Initial:\hspace{0.2cm}\makebox[1.5cm]{\hrulefill}}\\ \\*
	\tab{Schedule B} \tab{\textbf{\standards{}}} \tab{Initial:\hspace{0.2cm}\makebox[1.5cm]{\hrulefill}}\\ \\*

	\begin{minipage}[t]{0.65\textwidth}
		\begin{flushright}
			\vspace{1cm}\noindent \lodger{} Signature\hspace{0.2cm}\makebox[2in]{\hrulefill} \\*
			\textsuperscript{Print Name}

			\vspace{1cm}\noindent Owner Signature\hspace{0.2cm}\makebox[2in]{\hrulefill} \\*
			\textsuperscript{\mom{}}
		\end{flushright}
	\end{minipage}
	\hfill
