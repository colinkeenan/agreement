...
\begin{enumerate}
	\item Legally terminate this Rental Agreement with only 3 to 7 day written notice of termination delivered to \lodger{} in accordancewith items \ref{terminate} and \ref{service} of section \ref{generals} of this Agreement.
