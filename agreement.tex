...
\begin{multicols}{2}
	\begin{enumerate} 
		...
		\item \textbf{\furniture{}}\\* \label{furniture}
			...
			\textit{In Kitchen}\\*
			fully stocked with plates, bowls, cups, flatware, cutting boards, cookware, pizza pan, broiler pan, drip pan, dish clothes, hand towels, etc.\\*
			\textit{In Linen Closet}\\*
			bath towels, hand towels, wash cloths, fitted and flat sheets, blankets, pillows and pillow cases, etc.
