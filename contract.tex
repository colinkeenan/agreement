...
\input{attachmenttitles} %rules basic bathroom shopping bigchores shower insulin health notyourjob 
...
Thank you for providing this much-needed care! The following contract is to make sure we are all on the same page about responsibilities, sick days, taxes, payments and schedules. The attached ``\rules{}'' (Attachment \ref{rules}), ``\basic{}'' (Attachment \ref{basic}), ``\bathroom{}'' (Attachment \ref{bathroom}), ``\shopping{}'' (Attachment \ref{shopping}), ``\bigchores{}'' (Attachment \ref{bigchores}), ``\shower{}'' (Attachment \ref{shower}), ``\insulin{}'' (Attachment \ref{insulin}), ``\health{}'' (Attachment \ref{health}), and ``\notyourjob{}'' (Attachment \ref{notyourjob}) offer a little more information about how our family works and how we are hoping you can assist our loved one, written down so it can be clear. While the below contract is very black and white, the attachments will be agile documents as we know things might change.
...
\begin{enumerate}
	\item \textbf{\allweek{}}. \label{allweek}
		...
		\begin{tabular}{|p{\bw}|p{\sw}|p{\sw}|p{\sw}|}
			...
			Regular rate of pay & \$13.26 per hour & 12 hours & \$159.12\\ \hline
			Medical or Dental Appointments (varies weekly, but no more than 2 appointments per week) & \$13.26 per hour & 0 - 6 hours & \$0 - \$79.56\\ \hline
			...
			Weekly Totals: & &  14 - 20 hours & \makecell{\$159.12-\\\$238.68}\\
			\hline
		\end{tabular}
	\item \textbf{\weekend{}}. \label{weekend}
		Is not renting a room in the Employer's Home. Is required to work on Saturday and/or Sunday, but not on weekdays. May work additional days, even 7 days in one work-week, when the weekday employee is not available.
		\begin{enumerate}
	...
	\item \textbf{\weekday{}}. \label{weekday}
		...
		\begin{tabular}{|p{\bw}|p{\sw}|p{\sw}|p{\sw}|}
			...
			Weekly Totals: & & 13 - 19 hours & \makecell{\$172.38 -\\\$251.94}\\
			\hline
		\end{tabular}
\end{enumerate}
...
\begin{enumerate}
	...
	\item{\textbf{Tax Withholding/Reporting}}. Employee will complete Form I-9 (available at www.uscis.gov/forms) and provide the required documentation verifying employment eligibility within three days of hiring. Employer will withhold the required Social Security, Medicare, and State Disability Insurance taxes from the employee's pay. Federal and state income tax will not be withheld from employee's pay. In addition, Employer will match the employee's Social Security and Medicare contributions, make contributions to the state and federal unemployment insurance funds, and pay the state Employment Training Tax on behalf of the employee. Employer will provide employee with Form W-2 at the end of the year (by January 31). Employer will report employee's earnings to the Social Security Administration so that employee receives appropriate retirement benefits.
...
\begin{itemize}
		\item Rehabilitative or Therapeutic Physical Therapy
		\item Help with transfers (getting in and out of chair, from walker to toilet)
		\item Providing company at meals
		\item Assist with feeding
\end{itemize}
