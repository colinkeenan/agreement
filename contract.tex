...
\begin{enumerate}
	\item \textbf{\allweek{}}. \label{allweek}
		...
		\begin{tabular}{|p{\bw}|p{\sw}|p{\sw}|p{\sw}|}
			...
			Weekly Totals: & &  14 - 20 hours & \makecell{\$185.64 -\\\$265.20}\\
			\hline
		\end{tabular}
...
\begin{itemize}
		...
		\item Assist with walking
		\item Assist with exercises
		\item Providing company at meals
		\item Assist with feeding
		\item Garden maintenance
		\item Social visits to family and friends
		\item Going on walks or sitting outside
		\item Reading out loud
		\item Playing games (board, card, etc.)
		\item General Companionship and Conversation
\end{itemize}
